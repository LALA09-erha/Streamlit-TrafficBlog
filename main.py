...
sched.add_job(somet, 'interval', seconds=15)
sched.add_job(somet1, 'interval', seconds=15)
sched.add_job(somet2, 'interval', seconds=15)
sched.add_job(somet3, 'interval', seconds=15)
sched.add_job(somet4, 'interval', seconds=15)
sched.add_job(somet5, 'interval', seconds=15)
sched.add_job(somet6, 'interval', seconds=15)
sched.start()
